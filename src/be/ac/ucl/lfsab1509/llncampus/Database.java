...
public class Database {
		 ...
		 * @return ID of the new row. An integer lower than 0 in case of error.
		 */
		 ...
		 * @param table @see update
		 * @param whereMask @see update
		 * @param whereVal @see update 
		 ...
		 * @param values (optional) Values to insert on the query (if your query 
		 * contains ? [mask])
		 ...
		 * @param values The raw values to put into.
		 * @return the cursor of this raw query.
		 */
