...
/**
 * This class is intended to manage information shown on the list of subauditorium when 
 * the SubAuditoriumActivity is called.
...
public class SubAuditoriumListFragment extends LLNCampusListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		parentId = getActivity().getIntent().getIntExtra(LLNCampusActivity.EXTRA_PARENT_ID, 0);

		// Query the DB about the ISubAudtorium in the IAuditorium with the id parentId.
		String[] cols = {"AUDITORIUM_NAME"};
		Cursor c = db.select("Auditorium", cols, "BUILDING_ID = " + parentId, null, null, null,
				"AUDITORIUM_NAME ASC", null);
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		String[] cols = {"AUDITORIUM_ID", "AUDITORIUM_NAME", "BUILDING_ID", "PLACE", "MOBILIER",
				"CABINE", "ECRAN", "SONO", "RETRO", "DIA", "VIDEO", "RESEAU", "ACCESS"};
		Cursor c = super.db.select("Auditorium", cols, "AUDITORIUM_NAME = " + "'" 
				+ nameSubAuditorium + "'", null, null, null, null, null);
		c.moveToFirst();
		subauditorium = new SubAuditorium(parentId , c.getInt(0), c.getString(1), c.getInt(3),
	...
	/**
	 *  Interface for the listener of ISubAuditorium.
	 */
	public interface OnSubAuditoriumSelectedListener {
		 ...
		 * 
		 * @param subAuditorium
		 * 			The ISubAuditorium we want to show information about.
		 */
